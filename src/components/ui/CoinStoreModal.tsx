        ...
        {isOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md overflow-y-auto">
            ...
            >
              ...
              {/* TAB 2: COIN PACKS + REWARDED FREE ADS */}
              {activeTab === 'coins' && (
                <div className="space-y-5 relative z-10">
                  
                  {/* Free Rewarded Ad Card */}
                  <div className="p-4 rounded-2xl border border-[#CCFF00]/40 bg-[#CCFF00]/10 flex flex-col sm:flex-row items-center justify-between gap-3">
                    <div className="flex items-center gap-3 text-left">
                      <div className="w-10 h-10 rounded-xl bg-[#CCFF00] text-[#040507] font-black flex items-center justify-center text-lg shrink-0">
                        🎁
                      </div>
                      <div>
                        <span className="text-xs font-black text-white block">Watch 10s Sponsor Clip</span>
                        <span className="text-[11px] text-[#a0a0b8]">Earn +50 🪙 instantly for free without paying!</span>
                      </div>
                    </div>
                    ...
                    <button
                      ...
                      className="btn-volt px-4 py-2 text-xs font-black shrink-0 flex items-center gap-1.5"
                    >
                      <Play className="w-3.5 h-3.5 fill-current" /> Watch Video (+50 🪙)
                    </button>
                  </div>

                  <p className="text-xs text-[#a0a0b8] text-center">
                    Or instant coin vault packs for high-stakes duels & tournaments:
                  </p>
